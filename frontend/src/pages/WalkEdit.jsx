...
const renderButtons = [
  { id: 1, name: "Monday-Morning", style: {} },
  { id: 2, name: "Tuesday-Morning", style: {} },
  { id: 3, name: "Wednesday-Morning", style: {} },
  { id: 4, name: "Thursday-Morning", style: {} },
  { id: 5, name: "Friday-Morning", style: {} },
  { id: 6, name: "Saturday-Morning", style: {} },
  { id: 7, name: "Sunday-Morning", style: {} },
  { id: 8, name: "Monday-Afternoon", style: { order: 1 } },
  { id: 9, name: "Tuesday-Afternoon", style: { order: 1 } },
  { id: 10, name: "Wednesday-Afternoon", style: { order: 1 } },
  { id: 11, name: "Thursday-Afternoon", style: { order: 1 } },
  { id: 12, name: "Friday-Afternoon", style: { order: 1 } },
  { id: 13, name: "Saturday-Afternoon", style: { order: 1 } },
  { id: 14, name: "Sunday-Afternoon", style: { order: 1 } },
  { id: 15, name: "Monday-Evening", style: { order: 4 } },
  { id: 16, name: "Tuesday-Evening", style: { order: 4 } },
  { id: 17, name: "Wednesday-Evening", style: { order: 4 } },
  { id: 18, name: "Thursday-Evening", style: { order: 4 } },
  { id: 19, name: "Friday-Evening", style: { order: 4 } },
  { id: 20, name: "Saturday-Evening", style: { order: 4 } },
  { id: 21, name: "Sunday-Evening", style: { order: 4 } },
];
  ...
  useEffect(() => {
    if (walk) {
      setInput({
        ...
        weekdays: walk.weekdays,
        image: walk.image,
        castrated: walk.castrated,
      });
      setAddress({
        setAddress: toString(walk.location),
      });
    }
  }, [walk]);
        ...
        <Stack spacing={4}>
          ...
          <FormControl isInvalid={touched.weekdays && errors.weekdays}>
            ...
            >
              ...
              <Text>D</Text>
              <Text>Mañana</Text>
              <Text style={{ order: 1 }}>Tarde</Text>
              <Text style={{ order: 4 }}>Noche</Text>
